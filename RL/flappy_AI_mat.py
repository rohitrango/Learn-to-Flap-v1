...
try:    
    ...
    class QLearningModel:
        ...
        def __init__(self, epsilon=0.000001, epsilon_decay=0.995, learning_rate=0.7, gamma=0.95, maxlen=50000, inp_shape=3, out_shape=2, \
                        batch_size=50, epsilon_min=0.0):
        ...
        def replay(self):
            ...
            for mem in minibatch:
                ...
                # print(mem['state'], mem['next_state'])
                if not mem['done']:
